...
class OwnerACLAuthorizationPolicy(object):
    ...
    def __init__(self, owner_principal='role:owner'):
        self.owner_principal = owner_principal

    def _get_owner(self, context):
        owner = None
        for location in lineage(context):
            if owner is None and hasattr(location, '__owner__'):
    ...
    def permits(self, context, principals, permission):
        ...
        for location in lineage(context):
            ...
            for ace in acl:
                ...
                if owner is not None and ace_principal == self.owner_principal:
                    ace_principal = owner
